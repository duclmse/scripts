...
class CSVToSQLConverter:
    ...
    def determine_column_types(self, rows: list[dict]) -> dict[str, str]:
    ...
    def read_csv_file(self, file_path: str, delimiter: str | None = None) -> list[dict]:
    ...
    def read_csv_text(self, csv_text: str, delimiter: str | None = None) -> list[dict]:
    ...
    def generate_insert_sql(self, rows: list[dict], batch_size: int = 100) -> str:
...
def main():
    ...
    try:
        ...
        tb_frame = e_trace.tb_frame if e_trace else None
        print(
...
# ---------------------------------------------------------------------------
# Backward-compatibility re-export from the new package structure
# ---------------------------------------------------------------------------
from file_format.formats.sql_format import SQLFormat  # noqa: F401, E402
from file_format.formats.csv_format import CSVFormat  # noqa: F401, E402
