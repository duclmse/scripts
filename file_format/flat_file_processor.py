...
# ---------------------------------------------------------------------------
# Backward-compatibility re-exports from the new package structure
# ---------------------------------------------------------------------------
from file_format.formats.fixed_width import PositionText  # noqa: F401, E402
from file_format.processor import FlatFileProcessor  # noqa: F401, E402
