...
@Command.register("cl", aliases=["clone"], help="Clone resources", args=[
...
class CloneCommand:
    ...
    def execute(self, args):
        Logger.info(
            f"Cloning {args.resource_type}/{args.source} to {args.destination}...")
        ...
        try:
            ...
            Logger.success(
                f"Cloned to {args.destination} in namespace {target_ns}")
        finally:
