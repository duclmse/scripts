...
@Command.register("job", aliases=["jobs"], help="Manage Jobs and CronJobs", args=[
            ...
            for item in data.get('items', []):
                ...
                if args.status != "all":
                    if (args.status == "active" and job_status != "Running") \
                            or (args.status == "succeeded" and job_status != "Succeeded") \
                            or (args.status == "failed" and job_status != "Failed"):
                        continue
