...
def validate_label_selector(selector: str) -> tuple[bool, str | None]:
    """
...
def validate_port(port: str) -> tuple[bool, str | None]:
    """
...
def validate_cpu_request(cpu: str) -> tuple[bool, str | None]:
    """
...
def validate_memory_request(memory: str) -> tuple[bool, str | None]:
    """
...
def validate_replicas(replicas: str) -> tuple[bool, str | None]:
    """
...
def validate_image_name(image: str) -> tuple[bool, str | None]:
    """
